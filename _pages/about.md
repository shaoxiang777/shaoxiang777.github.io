...
<div style="display: flex; align-items: flex-start; margin-bottom: 20px;">
    <div style="flex: 0 0 400px; margin-right: 20px;">
        <img src="../images/inpaint360gs.gif" width="400"/>
    </div>
    <div style="flex: 1;">
        <h3 style="margin-top: 0;">Inpaint360GS: Efficient Object-Aware 3D Inpainting via Gaussian Splatting for 360° Scenes</h3>
        <p><strong>Shaoxiang Wang</strong>, Shihong Zhang, Christen Millerdurai, Didier Stricker, Alain Pagani</p>
        <p><em>WACV 2026 </em></p>
        <p>
...
<div style="display: flex; align-items: flex-start; margin-bottom: 20px;">
    <div style="flex: 0 0 400px; margin-right: 20px;">
        <img src="../images/uni-slam.gif" width="400"/>
    </div>
    <div style="flex: 1;">
        <h3 style="margin-top: 0;">Uni-SLAM: Uncertainty-Aware Neural Implicit SLAM for Real-Time Dense Indoor Scene Reconstruction</h3>
        <p><strong>Shaoxiang Wang</strong>, Yaxu Xie, Chun-Peng Chang, Christen Millerdurai, Alain Pagani, Didier Stricker</p>
        <p><em>WACV 2025</em></p>
        <p>
            <a href="https://arxiv.org/abs/2412.00242">[arXiv]</a>
...
<div style="display: flex; align-items: flex-start; margin-bottom: 20px;">
    <div style="flex: 0 0 400px; margin-right: 20px;">
        <img src="../images/mikasa.png" width="400"/>
    </div>
    <div style="flex: 1;">
        <h3 style="margin-top: 0;">Uni-SLAM: Uncertainty-Aware Neural Implicit SLAM for Real-Time Dense Indoor Scene Reconstruction</h3>
        <p>Chun-Peng Chang, <strong>Shaoxiang Wang</strong>, Alain Pagani, Didier Stricker</p>
        <p><em>CVPR 2024</em></p>
        <p>
